...
//
// This file is the core "guts" of every plugin. When copying plugin-virtual
...
//
// plugin-virtual uses identity decode — raw IS already canonical JSON.
...
//
// plugin-virtual uses identity encode — canonical JSON IS the protocol.
